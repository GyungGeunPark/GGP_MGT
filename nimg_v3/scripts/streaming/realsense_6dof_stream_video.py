...
PCA yaw 추정을 수행하고 TCP 서버를 통해 신호를 퍼블리시합니다.
...
def main():
    ...
    multi_tracker = PersistentMultiObjectTracker(fps=float(camera.fps), intrinsics=intrinsics)
