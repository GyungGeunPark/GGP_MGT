...
# C++ ICP용 고정 경로
CPP_INPUT_PCD = "/home/magenta/sl/gene1.pcd"
CPP_GLOBAL_PCD = "/home/magenta/sl/cropped_world_downsampled.pcd"

# CloudComPy용 고정 경로 및 설정
CLOUDCOMPY_WORKDIR = os.path.expanduser("~/cloudcompy")
CLOUDCOMPY_SCRIPT = "test1.py"
CLOUDCOMPY_MODEL_STL = "/home/magenta/sl/gene1.stl"  # 직접 STL 경로 지정

# 선택적 설정 (필요시 수정)
PRE_XFORM_PATH = "/home/magenta/cloudcompy/transformation_matrix_inverse.txt"  # C++ 선행 변환 행렬
OUTPUT_DIR = "/home/magenta/sl/global/out_icp_only"
ENABLE_VISUALIZATION = True  # Open3D 시각화 여부
...
def run_cpp_icp(timeout_sec: int = 60*30) -> ProcResult:
    ...
    cmd = ["bash", os.path.expanduser("~/scripts/run_cpp_icp.sh"), CPP_INPUT_PCD, CPP_GLOBAL_PCD]
...
def run_cloudcompy_icp(timeout_sec: int = 60*60) -> ProcResult:
    ...
    extra_args = [
        ...
        "--scan-pcd", CPP_GLOBAL_PCD,  # 전역 PCD 경로
        "--out-dir", OUTPUT_DIR,
    ]
    ...
    cmd = ["bash", os.path.expanduser("~/scripts/run_cloudcompy_icp.sh"),
